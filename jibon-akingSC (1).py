...
----------------------------------------------
 Author    : MD JIBON ISLAM
 Github    : MRXJIBON
 Facebook  : J  I  B  O  N
 Tool Name : Jibon-King
 Type type : PAID
 Version   : 1.10.
----------------------------------------------
 AKING Pro version 1.10.
        ...
        #       chk()
                ...
                if x == ("sex"):
                        ...
                        if xd in ['1','01']:
                                ...
                                os.system(f'xdg-open https://www.facebook.com/jibon.islam65653?mibextid=ZbWKwL{wx}');menu()
                        elif xd in ['7','07']:
                        ...
                        linex()
                        url_wa = "https://api.whatsapp.com/send?phone=01865544636&text="
